...
const PLANS: Plan[] = [
  {
    ...
    aiCredits: '3 AI creations for Canvas',
    ctaLabel: 'Sign up',
    ctaVariant: 'secondary',
    featuresIntro: 'Includes:',
    features: [
      'Unlimited manual creation for Slides, Sheets, Paper, and Canvas',
  ...
  },
  {
    ...
    features: [
      { label: 'Instant deck creation', icon: '/Icon/product-icons/slides-fill.svg' },
      { label: 'AI voice presentation mode', icon: '/Icon/product-icons/slides-fill.svg' },
      { label: 'Instant insights via AI analysis', icon: '/Icon/product-icons/sheets-fill.svg' },
      { label: 'Unlimited AI document creation', icon: '/Icon/product-icons/canvas-fill.svg' },
      { label: '20,000+ rows per data table', icon: '/Icon/product-icons/datatable-fill.svg' },
