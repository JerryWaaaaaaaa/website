...
const HERO_BASE: DialConfig = {
  ...
  meeting: {
    _collapsed: true,
    width: [15, 8, 50, 0.5], // % of hero container — fluid proportional size (~half the former 30%)
    maxWidth: [110, 80, 800, 10], // px — absolute ceiling, only clamps when the % width would exceed it
  },
};
